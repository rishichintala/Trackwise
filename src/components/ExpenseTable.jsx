...
//   FaBolt, FaGamepad, FaChartLine, FaQuestion, FaTrash, FaEdit, FaTimes
// } from "react-icons/fa";
...
//     <>
//       {expenses.length === 0 ? (
//         <div className="text-center text-gray-500 mt-8">No expenses yet. Start by adding one!</div>
//       ) : (
//         <div className="space-y-4 max-w-4xl mx-auto">
//           {expenses.map((exp) => (
//             <div key={exp.id} className="flex justify-between items-center bg-white p-4 rounded-xl shadow border">
//               <div>
//                 <div className="flex items-center gap-2 font-medium text-gray-800">
//                   {categoryIcons[exp.category] || categoryIcons["Miscellaneous"]}
//                   {exp.category}
//                 </div>
//                 <div className="text-sm text-gray-500">{new Date(exp.date).toDateString()}</div>
//               </div>
//               <div className="text-right">
//                 <div className="text-blue-500 font-bold text-lg">${Number(exp.amount).toFixed(2)}</div>
//                 <div className="flex justify-end gap-4 mt-2 text-gray-500 text-sm">
//                   <button onClick={() => setEditing(exp)} title="Edit"><FaEdit /></button>
//                   <button onClick={() => {
//     delExpense(exp.id);
...
//           <form onSubmit={handleEditSubmit} className="bg-white p-6 rounded-xl shadow-xl w-full max-w-md space-y-4 relative">
//             <button onClick={() => setEditing(null)} className="absolute top-3 right-3 text-gray-500 hover:text-red-500">
//               <FaTimes />
//             </button>
//             <h2 className="text-lg font-semibold text-gray-700">Edit Expense</h2>
...
export default function ExpenseTable() {
  ...
  // Ensure we re-apply the saved currency on mount:
  useEffect(() => {
